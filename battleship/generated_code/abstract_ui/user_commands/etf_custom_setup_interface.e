note
	description: "Summary description for {ETF_CUSTOM_SETUP_INTERFACE}."
	author: ""
	date: "$Date$"
	revision: "$Revision$"
...
feature {NONE} -- Initialization
	...
	make(an_etf_cmd_name: STRING; etf_cmd_args: TUPLE; an_etf_cmd_container: ETF_ABSTRACT_UI_INTERFACE)
		do
			...
			then
				out := "custom_setup(" + etf_event_argument_out("custom_setup", "dimension", dimension)+ "," +
						 etf_event_argument_out("custom_setup", "ships", ships) + "," +
						 etf_event_argument_out("custom_setup", "max_shots", max_shots) + "," +
						 etf_event_argument_out("custom_setup", "num_bombs", num_bombs) + ")"
			else
				etf_cmd_error := True
			end
		end
