note
	description: "Summary description for {OPERATION_CUSTOM_SETUP_TEST}."
	author: ""
	date: "$Date$"
	revision: "$Revision$"

class
	OPERATION_CUSTOM_SETUP_TEST
...
feature {NONE} -- constructor
	...
	make
		do
			...
			print("%NCUSTOM_SETUP_TEST OP make: state "+ stateNum.out + " " + msg_error.out + " -> " + msg_command.out)
...
feature
	op_name: STRING = "custom_setup_test"
